...
export function registerTools(server) {
    // Search Movies Tool
    server.tool("search-movies", "Search for movies by title or keywords", {
    ...
    server.tool("get-trending", "Get trending movies for day or week", {
    ...
    server.tool("get-similar", "Get movies similar to a given movie", {
    ...
    server.tool("get-movie-details", "Get detailed information about a specific movie", {
